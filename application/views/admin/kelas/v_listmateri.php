									...
									<div class="row">
										<div class="card col-sm-12 bg-blue mt-2">
											<div class="card-header">
												...
												<div class="card-tools pb-2">
													<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal_edit_tg<?= $id_tg; ?>">
														<i class="fas fa-edit"></i> Edit</button>
													<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal_hapus_tg<?= $id_tg; ?>">
														<i class="fas fa-trash"></i> Hapus</button>
												</div>
											</div>
										</div>
				...
				<form action="<?php echo base_url('admin/materi/create') ?>" method="post" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<textarea class="textarea" name="detail" placeholder="Isi Konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<textarea class="textarea" name="link" placeholder="Isi Konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
						<?= form_error('nama', '<small class="text-danger col-md">', '</small>'); ?>
					</div>
				</div>
				<div class="modal-footer justify-content-between">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="nama">Link Meeting</label>
						<textarea class="textarea" name="link" placeholder="Isi Konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $file_sub; ?></textarea>
						<?= form_error('nama', '<small class="text-danger col-md">', '</small>'); ?>
					</div>
				</div>
				<div class="modal-footer justify-content-between">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="isi">Isi Konten</label>
						<textarea class="textarea" name="detail" placeholder="Isi Konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $detail ?></textarea>
						<small class="form-text text-success">Berisi keterangan materi</small>
						<?= form_error('detail', '<small class="text-danger col-md">', '</small>'); ?>
					</div>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="nama" class="form-control" placeholder="Nama Menu" value="<?= set_value('nama'); ?>" required autofocus>
						<small class="form-text text-success">Contoh: Pengenalan dasar wirausaha</small>
						<?= form_error('nama', '<small class="text-danger col-md">', '</small>'); ?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="isi">Isi Konten</label>
						<textarea class="textarea" name="deskripsi" placeholder="Isi Konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?= set_value('deskripsi'); ?></textarea>
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input class="form-control pendaftaran" data-toggle="datetimepicker" data-target=".pendaftaran" type="text" id="deadline" name="deadline" value="<?= set_value('deadline'); ?>" placeholder="dd/mm/yyyy 00:00" autocomplete="off" required>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="nama">Nama File</label>
								<input type="text" name="nama" value="<?= $nm_tg; ?>" class="form-control" placeholder="Nama Menu">
								<small class="form-text text-success">Contoh: Pengenalan dasar wirausaha</small>
								<?= form_error('nama', '<small class="text-danger col-md">', '</small>'); ?>
							</div>
							<div class="form-group">
								<label for="status">Jenis File</label>
								<select class="form-control" id="jenis" name="jenis">
									<option value="fas fa-file-pdf" <?= $ic_tg == "fas fa-file-pdf" ? "selected" : "" ?>>PDF (.pdf)</option>
									<option value="fas fa-file-word" <?= $ic_tg == "fas fa-file-word" ? "selected" : "" ?>>Word (.doc/.docx)</option>
									<option value="fas fa-file-powerpoint" <?= $ic_tg == "fas fa-file-powerpoint" ? "selected" : "" ?>>Power Point (.ppt/.pptx)</option>
								</select>
								<small class="form-text text-success">Jenis tipe file yang akan di unggah</small>
								<?= form_error('jenis', '<small class="text-danger col-md">', '</small>'); ?>
							</div>
							<div class="form-group">
								<label for="isi">Isi Konten</label>
								<textarea class="textarea" name="deskripsi" placeholder="Isi Konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $detail; ?></textarea>
								<small class="form-text text-success">Berisi keterangan tugas</small>
								<?= form_error('deskripsi', '<small class="text-danger col-md">', '</small>'); ?>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									<input class="form-control pendaftaran" data-toggle="datetimepicker" data-target=".pendaftaran" type="text" id="deadline" name="deadline" value="<?= date('d F Y H:i', strtotime($deadline)); ?>" placeholder="dd/mm/yyyy 00:00" autocomplete="off" required>
									<div class="input-group-prepend">
										<span class="input-group-text">
											<i class="far fa-calendar-alt"></i>
										</span>
