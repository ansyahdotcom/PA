                                            ...
                                            <div class="form-group text-center" style="position: relative;">
                                                <span class="img-div">
                                                    ...
                                                    <div>
                                                        <img class="img-fluid img-responsive img-rounded shadow"
                                                            src="<?= base_url(); ?>assets/dist/img/kelas/<?= $kelas['GBR_KLS']; ?>"
                                                            onClick="triggerClick()" id="profileDisplay" width="250px">
                                                    </div>
                                                </span>
                                                <input type="file" name="gbrkls" value="<?= $kelas['GBR_KLS']; ?>"
                                                    onChange="displayImage(this)" id="profileImage" class="form-control"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" data-toggle="datetimepicker"
                                                    data-target=".pendaftaran" class="form-control pendaftaran"
                                                    id="inkls" name="tgl_daftar" value="<?= $daftar; ?>"
                                                    autocomplete="off" placeholder="dd/mm/yyyy 00:00" disabled>
                                    ...
                                    <div class="col-md-6 tgl_penutupan">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" data-toggle="datetimepicker" data-target=".penutupan"
                                                    class="form-control penutupan" id="inkls" name="tgl_penutupan"
                                                    value="<?= $penutupan; ?>" autocomplete="off"
                                                    placeholder="dd/mm/yyyy 00:00" disabled>
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        <i class="far fa-calendar-alt"></i>
                                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6 tgl_mulai">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" data-toggle="datetimepicker" data-target=".mulai"
                                                    class="form-control mulai" id="inkls" name="tgl_mulai"
                                    ...
                                    <div class="col-md-6 tgl_selesai">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" data-toggle="datetimepicker" data-target=".selesai"
                                                    class="form-control selesai" id="inkls" name="tgl_selesai"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="lok_kls" id="lok_kls" class="form-control" required>
                                                ...
                                                <option value="Online Class"
                                                    <?= $lok_kls == "Online Class" ? "selected" : "" ?>>Online Class
                                                </option>
                                                <option value="Offline Class"
                                                    <?= $lok_kls == "Offline Class" ? "selected" : "" ?>>Offline Class
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="hari" id="hari" required class="form-control">
                                                ...
                                                <option value="3 Hari (Senin-Rabu)"
                                                    <?= $hari == "3 Hari (Senin-Rabu)" ? "selected" : "" ?>>3 Hari
                                                    (Senin-Rabu)</option>
                                                <option value="4 Hari (Senin-Kamis)"
                                                    <?= $hari == "4 Hari (Senin-Kamis)" ? "selected" : "" ?>>4 Hari
                                                    (Senin-Kamis)</option>
                                                <option value="5 Hari (Senin-Jumat)"
                                                    <?= $hari == "5 Hari (Senin-Jumat)" ? "selected" : "" ?>>5 Hari
                                                    (Senin-Jumat)</option>
                                            </select>
                                        </div>
                                    </div>
