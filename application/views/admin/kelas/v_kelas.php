					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="namakls" placeholder="Nama Kelas" required autocomplete="off">
						...
						<div class="row">
							...
							<div class="col-md-6 row-idkls">
								<div class="form-group">
									...
									<input type="text" class="form-control text-bold" id="id" value="KLS00000<?= $id; ?>" disabled>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
