									...
									<tr>
										...
										<td>
											...
											if ($tgl_mulai == "" || $tgl_mulai == "1970-01-01") :
												...
												$mulai1 = date('d F Y', strtotime($tgl_mulai));
											endif;

											if ($tgl_selesai == "" || $tgl_selesai == "1970-01-01") :
												$selesai1 = "Tanggal belum diset !";
											else :
												$selesai1 = date('d F Y', strtotime($tgl_selesai));
											endif;
											?>
											<p><?= 'Mulai : ' . $mulai1; ?></p>
											<p><?= 'Selesai : ' . $selesai1; ?></p>
										</td>
										...
										<td class="text-center">
											<div class="row">
												<div class="col-md-6 pt-2">
													<a href="<?= base_url('admin/kelas/detailkls/' . $id); ?>" class="btn btn-sm btn-primary btn-block text-bold"><i class="fas fa-edit"></i> Detail</a>
												</div>
												<div class="col-md-6 pt-2">
