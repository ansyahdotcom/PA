		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<!-- /.card-header -->
					<form action="<?= base_url('pr_simpan_blog'); ?>" method="post" enctype="multipart/form-data"
						...
						<div class="card-body">
							...
							<button type="button" id="tambah_tags" class="btn btn-primary btn-xs btn-round"
								data-toggle="modal" data-target="#modal_tambah_tags">Tambah tags baru</button>
							<hr>
							...
							<button type="submit" class="btn btn-success btn-round">Posting</button>
						</div>
					</form>
					<!-- /.card-body -->
				</div>
			...
			<form method="post" action="<?= base_url('admin/blog/pr_tmbh_kategori'); ?>">
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="NM_CT">
					</div>
				</div>
...
<!-- Modal tambah tags -->
<div class="modal fade" id="modal_tambah_tags" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title title-1" id="myModalLabel">Tambah Kategori Blog</h4>
			...
			<form method="post" action="<?= base_url('admin/blog/pr_tmbh_tags'); ?>">
				<div class="modal-body">
					<div class="form-group">
						<input type="hidden" class="form-control" name="ID_TAGS" value="<?= $ID_CT; ?>">
						<input type="text" class="form-control" name="NM_TAGS">
					</div>
				</div>
				<div class="modal-footer">
					<button type="submit" id="save-btn" class="btn btn-success">Tambah</button>
