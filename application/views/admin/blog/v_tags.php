		...
		<div class="card-header">
			<div class="text-right">
				<button class="btn btn-primary" data-toggle="modal" data-target="#modal-tambah"><i
						class="fas fa-plus"></i> Tambah Tags</button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
								...
								<tr>
									...
									<td class="text-center" width="150px">
										<button class="btn btn-sm btn-primary" data-toggle="modal"
											data-target="#modal-edit<?= $tg->ID_TAGS; ?>"><b><i class="fas fa-edit"></i>
												Edit</b></button>
										<button class="btn btn-sm btn-danger" data-toggle="modal"
											data-target="#modal_hapus<?= $tg->ID_TAGS; ?>"><i class="fas fa-trash"></i>
											<b>Hapus</b></button>
									</td>
								</tr>
								<?php } ?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="post" action="<?= base_url('admin/Tags/update_Tags'); ?>">
				<div class="modal-body">
					<input type="hidden" readonly name="ID_TAGS" value="<?php echo $tg->ID_TAGS ?>"
						class="form-control">
					<div class="form-group">
						<input type="text" name="NM_TAGS" id="NM_TAGS" class="form-control" autocomplete="off"
							value="<?= $tg->NM_TAGS; ?>">
					</div>
				</div>
				<div class="modal-footer">
			...
			<form method="post" action="<?= base_url('admin/Tags/tambah_Tags'); ?>">
				<div class="modal-body">
					<div class="form-group">
						...
						<input required type="text" name="NM_TAGS" id="NM_TAGS" class="form-control"
                            placeholder="Masukkan Nama Tags . ." aria-describedby="namakatags" maxlength="100"
                            autocomplete="off">
					</div>
				</div>
				<div class="modal-footer">
