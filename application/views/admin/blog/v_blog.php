	...
	<section class="content">
		<div class="card-header">
			<div class="text-right">
				<a class="btn btn-primary" href="<?= base_url('admin/blog/tulis_artikel'); ?>"><i class="fas fa-plus-circle"></i> Artikel</a>
			</div>
		</div>
					...
					<div class="card">
						<div class="card-header">
							<div class="user-block">
								<span class="username m-0 text-lg">
									<a class="" href="<?= base_url('admin/blog/edit_artikel/' . $blg->JUDUL_POST . '/'); ?>"><?= str_replace('-', ' ', $blg->JUDUL_POST); ?></a>
								</span>
							</div>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12">
									...
									foreach ($detail_tags->result() as $dt) { ?>
										<a class="text-dark" href="#"><?= $dt->NM_TAGS; ?><?= $i == count((array) $detail_tags->result()) ? '' : ', ' ?></a>
									<?php $i++;
									} ?>
								</div>
								<div class="col-sm-3">
									<img class="card-img-top" src="<?= base_url('assets/fotoblog/fotoweb/' . $blg->FOTO_POST); ?>">
						...
						<div class="card-footer">
							<p>
								...
								<label for="TGL_POST" class="text-sm mr-2"><?= ' | ' . date('d F Y', strtotime($blg->TGL_POST)); ?></label>
								<span class="float-right">
									...
									<a class="btn btn-secondary btn-sm btn-round" href="<?= base_url('admin/blog/pratinjau/' . strtolower($blg->JUDUL_POST)); ?>"><i class="fas fa-eye"></i> Pratinjau</a>
									...
									<!-- hapus artikel -->
									<button type="button" id="detail" class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#modal_hapus<?= $blg->ID_POST; ?>" style="color : white"><i class="fas fa-trash"></i> Hapus</button>
								</span>
							</p>
						</div>
					</div>
