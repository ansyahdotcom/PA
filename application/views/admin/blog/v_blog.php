									...
									<div class="post">
										<div class="user-block">
											...
											<span>
												...
												<a class="link-black text-lg" href="<?= base_url('admin/blog/lihat_post_ktg'); ?>"><?= $blg->NM_CT; ?></a>
										...
										<p>
											...
											<span class="float-right">
												...
												<a class="btn btn-secondary btn-sm btn-round" href="<?= base_url('admin/blog/pratinjau/' . $blg->ID_POST); ?>"><i class="fas fa-eye"></i> Pratinjau</a>
