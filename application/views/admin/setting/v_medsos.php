                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalDetail<?= $id; ?>"><b>Detail</b></button>
                        <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalEdit<?= $id; ?>"><b>Edit</b></button>
                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modalDelete<?= $id; ?>"><b>Hapus</b></button>
                      </td>
                    </tr>
                    <?php $no++; ?>
                  <?php endforeach; ?>
