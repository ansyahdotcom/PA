            ...
            <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-header">
                            <h3 class="card-title pt-2"><?= $nama_nav;?></h3>
                            <div class="card-tools">
...
<?php foreach ($data as $p) :
    ...
    <form action="<?php echo base_url().'admin/navigasi/update'?>" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="modalEditSub<?= $id_nav;?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                ...
                <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <input type="hidden" name="id_navbar" value="<?=$id_nav;?>" required>
                <button type="submit" class="btn btn-warning"><i class="far fa-save"></i> Update</button>
                </div>
            </div>
        </div>
