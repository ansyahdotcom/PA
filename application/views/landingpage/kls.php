			...
			<div class="row h-100 align-items-center">
				...
				<div class="site-buttons p-5">
					<div class="d-flex flex-row flex-wrap">
						...
						<img src="<?= base_url(); ?>assets/dist/img/program/study.svg" width="500" alt="gambar kelas" class="img-fluid ml-5">
					</div>
				</div>
			</div>
			</div>
		...
		<div class="container p-5 mt-5 mb-5">
			<div class="row">
				...
				<div class="card-footer">
					<div class="harga">
						<h5 class="float-right font-weight-bold">Rp. <?= number_format($k->PRICE, 0, ".", "."); ?></h5>
					</div>
					<span class="badge bg-warning">Kategori: <?= $k->KTGKLS?></span>
				</div>
				<a href="<?= base_url('class/detail/'.$k->ID_KLS);?>" class="btn btn-primary font-weight-bold text-uppercase m-2">Lihat Detail</a>
				</div>
			</div>
			<?php endforeach;?>
			</div>
    			...
    			<div class="row p-5">
    				<div class="col-lg-6 col-md-12">
    					<div class="about-image">
    						<img src="<?= base_url(); ?>assets/dist/img/about-us.png" width="500" alt="About us" class="img-fluid">
    					</div>
    				</div>
