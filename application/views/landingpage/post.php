    ...
    <div class="row">
      <div class="col-md-8 blog-main">
        ...
        <div class="blog-post card mb-4">
          <img class="card-img-top" src="<?= base_url('assets/fotoblog/'.$row->FOTO_POST); ?>" alt="Card image cap">
          <div class="card-body">
            ...
            <a href="<?= base_url('blog/detail/'.strtolower($row->JUDUL_POST));?>" class="btn btn-primary">Read More &rarr;</a>
          </div>
          <div class="card-footer text-muted">
            Di posting pada <i class="fas fa-calendar"></i> <?= $row->TGL_POST?> Oleh 
            <a href="#">Admin</a>
          </div>
        </div>
        <!--  ======================= Batas Blog post ============================== -->
