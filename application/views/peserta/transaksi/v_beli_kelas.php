                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kelas" name="kelas" value="<?= $kelas['TITTLE']; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="namaps" name="nmps" value="<?= $peserta['NM_PS']; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="hp">No HP</label>
                                            <input type="text" class="form-control" id="hp" name="hp" value="<?= $peserta['HP_PS']; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="text" class="form-control" id="email" name="email" value="<?= $peserta['EMAIL_PS']; ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="exampleCheck1" required>
                                    <label class="form-check-label" for="exampleCheck1">Mencentang ini berarti anda menyetujui segala jenis ketentuan transaksi yang berlaku.</label>
                                </div>
                            </div>
                            <!-- /.card-body -->

                            <div class="card-footer float-right">
                                <a href="<?= base_url('peserta/kelas'); ?>" class="btn btn-default"><i class="fas fa-arrow-circle-left"></i> Batal</a>
                                <button type="submit" class="btn btn-primary" id="pay-button"><i class="fas fa-money-bill"></i> Bayar</button>
                            </div>
                    </div>
                    </form>
                </div>
