        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div class="col-sm-12">
              <div class="alert alert-primary alert-sm" role="alert">
                <div class="row">
                  ...
                  <p>Halo, (User) anda login sebagai <?php if ($this->session->userdata('role')==2) {
                    echo "Peserta";
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="inner">
                <h3>0</h3>
                <p class="text-uppercase"><center>Sertifikat</center></p>
                </div>
                <div class="icon">
