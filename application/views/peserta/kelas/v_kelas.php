								...
								<div class="row">
									...
									<div class="col-5 text-center">
										<img src="<?= base_url('assets/dist/img/kelas/' . $gambar); ?>" alt=""
											class="img-responsive img-fluid img-rounded shadow">
									</div>
								</div>
							</div>
		...
		<div class="modal-content">
			...
			<form id="payment-form" method="POST" action="<?= site_url() ?>/peserta/kelas/finish">
				...
				<div class="modal-footer justify-content-between">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal" name="continue"
						id="continue">Lanjut Cekout</button>
				</div>
			</form>
		</div>
		<!-- /.modal-content -->
