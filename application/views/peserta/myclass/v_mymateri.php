					...
					<div class="row">
						<div class="col-7 col-sm-9">
							<div class="tab-content card p-3" id="vert-tabs-right-tabContent">
								...
								<div class="tab-pane fade show active p-3 mb-2 mt-2 bg-info" id="vert-tabs-right-<?= $e['NM_MT']?>"
									role="tabpanel" aria-labelledby="vert-tabs-right-<?= $e['NM_MT']?>-tab">
									<div class="detail mb-4">
										<?= $e['DETAIL_SUB'];?>
									</div>
									<div class="file mt-1 d-flex">
										<a href="#" class="btn btn-warning mr-1 ml-1"><i class="<?= $e['ICON_SUB'];?>"></i>
											<?= $e['FILE_SUB'];?></a>
									</div>
								</div>
								<?php endforeach;?>
