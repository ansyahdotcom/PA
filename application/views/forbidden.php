        ...
        <div class="col-md-12 text-center">
            ...
            <div class="error-template">
                ...
                <div class="error-details">
                    Anda tidak bisa mengakses halaman yang anda tuju. Silahkan klik button dibawah untuk kembali
                </div>
                <div class="error-actions mt-5">
                    <div class="row justify-content-center">
                        <div class="col-md-6 text-center">
                            <?php if ($this->session->userdata('role') == 1) {?>
                                <a href="<?=base_url('admin/dashboard');?>" class="btn btn-outline-primary"><i class="fas fa-home"></i> kembali ke dashboard</a>
                            <?php } else {?>
                                <a href="<?=base_url('peserta/dashboard');?>" class="btn btn-outline-primary"><i class="fas fa-home"></i> kembali ke dashboard</a>
                                <?php } ?>
                        </div>
                    </div>
                </div>
