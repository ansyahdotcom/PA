...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2020 at 04:00 AM
...
INSERT INTO `webinar` (`ID_WEBINAR`, `TEMA`, `PEMATERI`, `FOTO_PEMATERI`, `HARGA`, `PLATFORM`, `TGL_WEB`, `TGL_POSTWEB`, `ST_POSTWEB`) VALUES
(1, 'Ayo Belajar!', 'Mustika Khoiri', 'Koala1.jpg', 'GRATIS', 'ZOOM', '1970-01-01', '2020-12-07', NULL),
(2, 'Coba Dulu Yuk!', 'Tika', 'Koala1.jpg', '25.000', 'ZOOM', '1970-01-01', '2020-12-07', NULL);
...
--
ALTER TABLE `webinar`
  MODIFY `ID_WEBINAR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
