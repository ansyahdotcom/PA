...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Des 2020 pada 14.56
...
('ADM0000', 1, 'Koala1.jpg', 'AHP', '089775667775', 'Solo, Jawa Tengah.', 'turtleninjaaa77@gmail.com', '$2y$10$ZN7xKarMFaxyPLS2AbLeAOU8Iw9SHshJJRl2ZXOEIgQvnSPknRiLi', 1, 0, 1605846204, 1605846423);
...
(12, 'ADM0000', 4, 0, 'Dasar-dasar berwirausaha untuk pemula', 'dasar', 'Jellyfish.jpg', 'Kelas ini merupakan kelas dasar bagi para pemula yang ingin terjun ke dunia bisnis', 100000, '1', 1605844837, 1606957498),
...
('PSR00001', 2, 'default.jpg', 'budi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '089997889997', NULL, 'budi@gmail.com', '$2y$10$2af5FrN2r1/JDU7HDlFgXec7SBgabNgAxMasMd68LSTs2cJ7.ZEqa', '1', '1607522845', '0');
...
(11, 'budi4@gmail.com', 'WeB+hVDpIjD7FpHocteIwCMdXz8gMTxNFoURBCkfeeY=', '1607522845'),
(12, 'doremi@gmail.com', 'ef1hyQEfGarH5H95OTguY6KvVs+CQMzI1AqGf2NJ44c=', '1607527523'),
(13, 'asd@gmail.com', 'CD6gtxDfuEzCzS0X+/jWyiLXyxeB7/EkHtuzZ6Nl1tA=', '1607527649'),
(14, 'cmiiww@gmail.com', 'ySyVSZIphosqiPAuAoTQAg2ErZXcyM6w1QyJaQVAVvQ=', '1607532444'),
(15, 'cmiiww@gmail.com', 'bRAt46DWPM41b/vDtQDt4mOip6vvCKZ0C3JL63ai2oo=', '1607532606');
...
--
ALTER TABLE `kelas`
  MODIFY `ID_KLS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
ALTER TABLE `detil_tugas`
  ...
  ADD CONSTRAINT `FK_MTKELAS` FOREIGN KEY (`ID_MT`) REFERENCES `materi` (`ID_MT`) ON DELETE CASCADE ON UPDATE CASCADE;
