...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Des 2020 pada 17.12
...
('ADM0000', 1, 'Koala1.jpg', 'Agus Hadi Prayitno, S. Pt., M. Sc., CPC.', '089775667775', 'Solo, Jawa Tengah.', 'turtleninjaaa77@gmail.com', '$2y$10$JqNY.x02erU1MVtJCYfyiulSluajd8DzPafEXsnIAzySdCWFRwEim', 1, '0', '1605846204', '1605846423');
...
(5, 'ADM0000', 1, 0, 'Ada Apa dengan Tubuhku? Bagaimana Islam Menyiapkan Masa Puber Anak', 'baru', 'default.jpg', 'halloo teman', 170000, '1', 1605356875, 1607936491, 'Online Class', '2020-12-18', '2020-12-16', '3 Hari (Senin-Rabu)', '08.00', '11.00'),
(6, 'ADM0000', 2, 0, 'Strategi Bisnis Lewat Sosmed', 'sosmed', 'default.jpg', 'Halloooo', 200000, '1', 1605526657, 1607936532, 'Online Class', '2020-12-15', '2020-12-22', '3 Hari (Senin-Rabu)', '', '');
...
(1, 'PS00000001', 'Pendaftar baru', 'Ada pendaftar baru, atas nama Alex.', 'admin/peserta', '0', '0', '2020-12-25 20:50:15'),
(2, 'PS00000001', 'Selamat datang!', 'Selamat bergabung di Preneur Academy', 'peserta/profil', '0', '1', '2020-12-25 20:50:15'),
(3, 'PS00000001', 'Aktivasi akun', 'Pendaftar dengan nama Alex berhasil mangaktivasi akun.', 'admin/peserta', '0', '0', '2020-12-25 20:50:15');
...
('PS00000001', 2, 'default.jpg', 'Alex', NULL, NULL, NULL, NULL, NULL, '085778990009', NULL, 'kurak4647@gmail.com', '$2y$10$p0EZ9IqwxLBecz5FEbnUd.y4Wigi8Gr5EzIRGP1zq6j5IqSva/eBS', '1', '1608904215', 0),
('PS00000002', 2, 'default.jpg', 'Jarvi', NULL, NULL, NULL, NULL, NULL, '087667887778', NULL, 'jarvi@gmail.com', '$2y$10$p0EZ9IqwxLBecz5FEbnUd.y4Wigi8Gr5EzIRGP1zq6j5IqSva/eBS', '1', '1608904215', 0);
...
--
ALTER TABLE `kelas`
  MODIFY `ID_KLS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `materi`
  MODIFY `ID_MT` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
